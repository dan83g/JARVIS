    ...
    return (        
        <span className="p-input-icon-left p-input-icon-right width-100">
            <i className="search-input-icon pi pi-search" />
                ...
                <ButtonControl visible={Boolean(typeValue)} type="button" className="search-type-btn btn-type suffix p-input-suffix p-button-text border-radius-10"  onClick={(e) => cmTypes?.current?.show(e)} label={typeValue}/>
            <i/>
        </span>
    )
}    